...
class RFQForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            ...
            field.label_attrs = {"block text-sm font-medium leading-6 text-gray-900"}
...
class aceRFQForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            ...
            field.label = field.label or self.humanize_field_name(field_name)
            field.label_attrs = {'class': "block w-full rounded-md border-0 py-1.5 text-gray-900 bg-white shadow-sm "
