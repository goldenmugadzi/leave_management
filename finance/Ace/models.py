...
class Ace(models.Model):
    ...
    section_head_approval_status = models.CharField(max_length=20, blank=True, null=True)
    ...
    accounting_officer_approval_status = models.CharField(max_length=20, blank=True, null=True)
    accounting_officer_rejection_reason = models.CharField(max_length=25,blank=True,null=True)
    accounting_officer_approval_date = models.DateField(null=True, blank=True)

    finance_manager = models.CharField(max_length=30, blank=True, null=True)
