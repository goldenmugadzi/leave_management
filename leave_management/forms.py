...
class LeaveRequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            ...
            if (field_name == 'user') or (field_name == 'employee_types') or ( field_name == 'type_of_leave') or ( field_name == 'department') or ( field_name == 'region') or ( field_name == 'gender') or ( field_name == 'position'):
