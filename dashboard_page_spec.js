...
class DashboardFilter extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      metrics: {
        energy_sold: { value: "", unit: "", target: "", target_unit: "", progress: 0 },
        growth: { value: "", unit: "", target: "", target_unit: "", progress: 0 },
        revenue_usd: { value: "", unit: "", target: "", target_unit: "", progress: 0 },
        revenue_zwl: { value: "", unit: "", target: "", target_unit: "", progress: 0 },
        faults: { value: "", unit: "", target: "", target_unit: "", progress: 0 },
        maintenance: { value: "", unit: "", target_unit: "", progress: 0 }
      },
  ...
  render() {
    ...
    if (!this.state.isLoading && 
        ...
        (!this.state.pbncs || this.state.pbncs.length === 0) &&
      ...
      return (
        <div className="dashboard-error" style={{ margin: '20px', textAlign: 'center' }}>
          <h3 style={{ marginBottom: '16px' }}>No Data Available</h3>
          <p>No dashboard data is currently available. This could be because:</p>
          <ul style={{ textAlign: 'left', display: 'inline-block', marginTop: '10px' }}>
            <li>• The backend API endpoints are not configured</li>
            <li>• The database is empty or not accessible</li>
            <li>• There are no records matching the current filters</li>
            <li>• The dashboard data tables are empty</li>
          </ul>
          <p style={{ marginTop: '10px', fontSize: '14px', color: '#6b7280' }}>
            {BASE_URL ? 
              'The dashboard is properly configured but no data is available. Please ensure the database contains the required data.' :
              'The dashboard is not properly configured. Please contact your administrator to set up the required API endpoints.'
            }
          </p>
          <button
            className="dashboard-error-retry"
    ...
    return (
      <div>
        ...
        {this.state.isLoadingPermissions && (
          <div className="bg-yellow-100 border-l-4 border-yellow-400 p-3 mb-3">
            <div className="flex">
              <div className="text-yellow-800">🔄 Loading permissions...</div>
            </div>
          </div>
        )}
          ...
          <div className="bg-gray-100 border-l-4 border-gray-400 p-3 mb-3">
            <div className="flex justify-between items-center">
              <div className="text-gray-800">
                <strong>Debug Info:</strong> canEdit: {this.state.canEdit.toString()}, 
                Roles: {this.state.userRoles.join(', ') || 'None'}, 
                Loading: {this.state.isLoadingPermissions.toString()}
              </div>
              <button 
              ...
              <div style={{ flex: 0.25 }} className="flex justify-center">
                <div className="w-full">
                  ...
                  >
                    ...
                    {!this.state.isLoadingRegions && this.state.regions && this.state.regions.length > 0 ? (
              ...
              <div style={{ flex: 0.25 }} className="flex justify-center">
                <div className="w-full">
                  ...
                  >
                    ...
                    {!this.state.isLoadingRegions && this.state.districts && this.state.districts.length > 0 ? (
              ...
              <div style={{ flex: 0.25 }} className="flex justify-center">
                <div className="w-full">
                  ...
                  >
                    ...
                    {!this.state.isLoadingRegions && this.state.depots && this.state.depots.length > 0 ? (
