...
class Command(BaseCommand):
    help = 'Import debtor categories data from CSV/Excel file'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--month', type=int, required=True, help='Month for the data (1-12)')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            required_cols = ['category', 'percentage']
