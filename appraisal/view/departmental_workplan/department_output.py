...
from ...forms.departmental_plan import DepartmentOutputCreateForm
...
def get_dept_output_weight_progress(dept_objective_id: int):
    handler = DepartmentOutputService(repo=DepartmentalOutRepository())
    return handler.get_weight_progress(dept_objective_id=dept_objective_id)
...
class DepartmentOutputTemplateView(TemplateView):
    ...
    def get_all_outputs(self):
        ...
        return repo.fetch_by_department_objective_id(department_objective_id=self.kwargs.get("departmental_objective_id"))
