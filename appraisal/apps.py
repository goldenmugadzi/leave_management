...
class AppraisalConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        from appraisal.signals.appraisal import create_performance_review_post_save_handler, create_training_development_post_save_handler, send_appraiser_email_post_save_handler, assign_appraisee_role_post_save_handler
