...
class NonconformityForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            ...
            if (field_name == 'cost_center') or (field_name == 'violation_standard_reference') or (field_name == 'recipient'):
                field.widget.attrs.update({
                    'class': "0 block w-full rounded-md border-0 py-1.5 text-gray-900 "
