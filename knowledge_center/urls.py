...
urlpatterns = [
    ...
    path('nav/tree/<int:folder_id>/', views.load_tree_branch, name='kc_tree_branch'),
    path('nav/folder/<int:folder_id>/content', views.folder_content, name='kc_folder_content'),
    path('nav/search', views.search_navigation, name='kc_nav_search'),
