...
class Query( UserQuery,TokenQuery, BatteryMaintenanceQuery , graphene.ObjectType):
    pass

class Mutation( TokenMutation, BatteryMaintenanceMutation, graphene.ObjectType):
