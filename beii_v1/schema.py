...
from it.users.schema import Query as UserQuery, Mutation as UserMutation
...
class Mutation(TokenMutation, UserMutation, BatteryMaintenanceMutation, ToolsAndEquipmentMutation, RiskMutation, DocumentMutation, graphene.ObjectType):
