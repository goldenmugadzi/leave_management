...
urlpatterns = [
    ...
    path(
        "user/change-password", views.change_user_password, name="change_user_password"
    ),
    ...
    path(
        "user/center/parents/<str:center_code>",
        views.get_center_parents,
        name="get_center_parents",
    ),
    path(
        "filtered_districts/<str:region_id>",
        views.get_filtered_districts,
        name="filtered_regions",
    ),
    path(
        "filtered_centers/<str:region_id>",
        views.get_filtered_centers,
        name="get_filtered_centers",
    ),
    path(
        "filtered_depots/<str:district_id>",
        views.get_filtered_depots,
        name="filtered_depots",
    ),
    ...
    path("never-logged-in/", views.users_never_logged_in, name="users_never_logged_in"),
